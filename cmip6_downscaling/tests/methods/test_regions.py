...
## Note: test_generate_subdomains and test_combine_outputs are currently failing and are commented out. hmm yea both seem to be due to the 180 to 360 change. and add a todo to say fix when switching from 360 to 180 again
