...
_defaults = {
    ...
    "runtime": {
        "cloud": {
            ...
            "agent": "az-eu-west",
            "extra_pip_packages": "git+https://github.com/carbonplan/cmip6-downscaling.git@testing/prefect_1.0 scikit-downscale==0.1.3 prefect==1.2.2 rechunker==0.5.0 --no-deps ",
            "kubernetes_cpu": 15,
