...
_defaults = {
    ...
    "runtime": {
        "cloud": {
            ...
            "agent": "az-eu-west",
            "extra_pip_packages": "git+https://github.com/carbonplan/cmip6-downscaling.git git+https://github.com/pangeo-data/rechunker git+https://github.com/pangeo-data/scikit-downscale@fill-value",
            "kubernetes_cpu": 2,
