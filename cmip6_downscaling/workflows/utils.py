...
def rechunk_dataset(ds, chunks_dict, connection_string, max_mem='500MB'):
    ...
    store_tmp = fsspec.get_mapper('az://cmip6/temp/{}.zarr'.format(path_tmp), connection_string=connection_string)
    store_tgt = fsspec.get_mapper('az://cmip6/temp/{}.zarr'.format(path_tgt), connection_string=connection_string)
    ...
    print(rechunked_ds['tasmax'].data.chunksize)
